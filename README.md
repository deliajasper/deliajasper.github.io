...
```
.
├── jekyll/                # Jekyll source (pages, _posts, layouts, Gemfile)
├── projects/              # Standalone project pages (static HTML)
├── files/                 # Downloadable files/assets
├── images/                # Images and videos used on the site
├── _site/                 # Generated site (build output)
├── index.html             # Top-level index, the home page
└── README.md              # This file
